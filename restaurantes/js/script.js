        ...
        if (numero === 20) {
            resultadoContainer.innerHTML = `
                <div class="resultado-box">
                    ...
                    <p class="sucesso">Parabéns, você tirou um acerto crítico! Isso significa que ao invés de ir a um restaurante comum da lista, você pode escolher um restaurante estrela do Michelin para comer!</p>
                </div>
                `;
        } else if (numero === 1) {
            resultadoContainer.innerHTML = `
